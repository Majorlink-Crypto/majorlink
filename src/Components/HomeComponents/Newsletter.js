...
const Newsletter = () => {
  return (
    ...
    <div className='md:m-20 md:mt-0 mt-20 md:mx-0 mx-1'>
        <div className='md:m-20 bg-newsletter bg-cover md:p-10 p-4  rounded-md '>
             {/*Header*/}
                 ...
                 <div className='font-gilroy mt-8 flex mb-4'>
                     <input className='p-2 rounded-md mr-8 md:w-[40%] w-[65%] text-sm' placeholder='youremail@example.com'>
                     </input>
