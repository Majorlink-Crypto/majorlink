        ...
        <div className='md:m-20 bg-newsletter bg-cover md:p-10 p-6 rounded-md '>
             {/*Header*/}
                 ...
                 <div className='font-gilroy mt-8 flex mb-10'>
                     <input className='p-2 rounded-md mr-8 w-[40%]' placeholder='email'>
                     </input>

                     <button className='bg-white text-black p-2 rounded-md font-bold font-poppins px-10'> Subscribe</button>
                 </div>
              {/*Header*/}
        </div>
    </div>
