...
import bince from "../../Assets/stablecoinsmaj.png";
    ...
    <div className="md:px-20 md:py-24 pt-32 items-center justify-center px-3 bg-[#4B5DFF] pb-6">
      ...
      <div className="md:flex flex flex-col md:flex-row md:justify-center md:space-x-4 md:items-center md:px-10 px-4">
        <div className="text-[#ffffff] md:w-[60%]">
          <h2 className="md:text-3xl text-xl font-grifter tracking-wide md:mt-20 mt-10">
            Trade your GiftCards & Crypto
          </h2>
          <h2 className="bigtext md:text-6xl text-5xl mt-4 font-grifter tracking-wide">
            Easy with Speed.
          </h2>
          <p
            className="text-[#ffffff] text-base font-aeonikregular text-start md:w-[78%] w-[95%] mt-4 tracking-wide"
            data-aos="fade-up"
          >
            Experience lightning-fast trades with unbeatable rates. Join
            thousands of satisfied users worldwide who trust Majorlink for
            secure, instant cryptocurrency and gift card exchanges.
          </p>
            ...
            <div className="md:flex items-center md:space-x-6 mt-6 space-y-2">
              <a href="https://play.google.com/store/apps/details?id=com.olamide81.MajorlinkApp">
                <span className="bg-[#fff] rounded-full md:py-4 py-4 md:px-10 px-3 flex items-center justify-center space-x-2 md:w-auto w-[58%] cursor-pointer">
                  ...
                  <div>
                    <p className="font-aeonikmedium md:text-sm text-xs text-[#4B5DFF]">
          ...
          <div className="md:mt-20 mt-14 flex items-center">
            ...
            <div>
              ...
              <h1 className="mt-1 ml-1 text-[#DBDEF9] flex text-lg items-baseline font-grifter">
                /5{" "}
                <p className="font-aeonik text-xs ml-2">
                  Google Playstore & iOS store
                </p>
              </h1>
            </div>
          </div>
        ...
        <span className="md:mt-0 mt-6 md:w-[50%] flex justify-center items-center" data-aos="fade-left">
          <img
            className="mt-[-20] w-[120%] md:flex hidden"
            src={bince}
            alt="img"
          />
        </span>
      ...
      <div className="absolute w-[90%] md:block hidden">
        ...
        <div className="flex items-start justify-between rounded-2xl mt-14 bg-[#F9F9FE] font-gilroy mx-6 py-10 px-10 z-10">
          <div className="w-[20%]">
            <h1 className="text-[#4354ED] text-2xl font-grifter">$1M</h1>
            <p className="text-[#5B64AF] text-sm mt-1 font-aeonikmedium">
              Majorlink's daily trade volume.
            </p>
          </div>
          <div className="w-[20%]">
            <h1 className="text-[#4354ED] text-2xl font-grifter">10K</h1>
            <p className="text-[#5B64AF] text-sm mt-1 font-aeonikmedium">
              Our growing user base.
            </p>
          </div>
          <div className="w-[20%]">
            <h1 className="text-[#4354ED] text-2xl font-grifter">5 Min</h1>
            <p className="text-[#5B64AF] text-sm mt-1 font-aeonikmedium">
              Average completion time.
            </p>
          </div>
          <div className="w-[20%]">
            <h1 className="text-[#4354ED] text-2xl font-grifter">100%</h1>
            <p className="text-[#5B64AF] text-sm mt-1 font-aeonikmedium">
              Guaranteed uptime.
            </p>
          </div>
